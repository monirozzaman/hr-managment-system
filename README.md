...
To build the final jar and optimize the hr_managment_system application for production, run:
...
Then navigate to [http://localhost:3004](http://localhost:3004) in your browser.
